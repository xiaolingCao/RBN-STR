...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn1 = RepresentativeBatchNorm2d(planes)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
        self.bn2 = RepresentativeBatchNorm2d(planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn3 = RepresentativeBatchNorm2d(planes * 4)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
...
class Convkxk(nn.Module):
    def __init__(self,
        ...
        self.conv = nn.Conv2d(in_planes,
                              ...
                              padding=padding,
                              bias=False)
        self.bn = RepresentativeBatchNorm2d(out_planes)
        self.relu = nn.ReLU(inplace=True)
        ...
        for m in self.modules():
            ...
            elif isinstance(m, RepresentativeBatchNorm2d):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.bn1 = RepresentativeBatchNorm2d(64)
        self.relu1 = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(64, 64)
        self.bn2 = RepresentativeBatchNorm2d(64)
        self.relu2 = nn.ReLU(inplace=True)
        self.conv3 = conv3x3(64, 128)
        self.bn3 = RepresentativeBatchNorm2d(128)
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                nn.Conv2d(self.inplanes,
                          ...
                          stride=stride,
                          bias=False),
                RepresentativeBatchNorm2d(planes * block.expansion),
            )
